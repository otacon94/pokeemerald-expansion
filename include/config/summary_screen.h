...
// IV/EV flags
#define P_FLAG_SUMMARY_SCREEN_IV_EV_INFO FLAG_SUMMARY_IV_EV_INFO      // If this flag is set, will allow player to cycle through the Stats, IVs, and EVs in the summary screen skills page. Note: if P_SUMMARY_SCREEN_IV_EV_INFO is TRUE, this flag does nothing.
...
#define P_FLAG_EGG_MOVES                 FLAG_RELEARN_EGG_MOVES       // If this flag is set, enables egg move relearner.
#define P_FLAG_TUTOR_MOVES               FLAG_RELEARN_TUTOR_MOVES       // If this flag is set, enables tutor move relearner.
