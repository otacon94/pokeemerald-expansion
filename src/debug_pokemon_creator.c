...
static bool8 DebugPkmCreator_IsShiny(u32 otId, u32 personality);
...
static const u8 Str_Nuzlocke[] = _("World Ribbon");
...
static const struct EditPokemonStruct DebugPkmCreator_Options[] =
{
        ...
        [VAL_BALL]                 = {Str_Ball, EDIT_NORMAL, 0, ITEM_CHERISH_BALL, ITEM_POKE_BALL, MON_DATA_POKEBALL, 2},
        ...
        [VAL_RIBBON_FATEFUL2]      = {Str_Nuzlocke, EDIT_NORMAL, 0, 3, 0, MON_DATA_WORLD_RIBBON, 1},
        // Move data
...
static bool8 DebugPkmCreator_GetShinyModifier(void)
{
    ...
    return GetMonData(&sDebugPkmCreatorData.mon, MON_DATA_IS_SHINY, NULL) ^ natural;
}

static bool8 DebugPkmCreator_IsShiny(u32 otId, u32 personality)
{
    return (GET_SHINY_VALUE(otId, personality) < SHINY_ODDS) ^ DebugPkmCreator_GetShinyModifier();
}
...
static void DebugPkmCreator_Init_SetNewMonData(bool8 setMoves)
{
    ...
    CreateMon(mons, sDebugPkmCreatorData.data[0], sDebugPkmCreatorData.data[15], sDebugPkmCreatorData.data[1], OTID_STRUCT_PRESET(data));
...
static void DebugPkmCreator_PopulateDataStruct(void)
{
    ...
    for (i = 0; i < EDIT_OPTION_COUNT; i++)
    {
        ...
        case VAL_MOVE_1_PPUP ... VAL_MOVE_4_PPUP:
            ...
            break;
        case VAL_IS_SHINY:
            sDebugPkmCreatorData.data[i] = GetMonData(mons, MON_DATA_IS_SHINY, NULL);
            break;
        }
    }
}
    ...
    for (i = 0; i < 6; i++)
    {
        ...
        case VAL_SPECIES:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NARROW, gStringVar2, x, y, 0, NULL);
            x = 140;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, GetSpeciesName(sDebugPkmCreatorData.data[index]), x, y, 0, NULL);
            break;
        case VAL_LEVEL:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
        ...
        case VAL_PID:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NARROW, gStringVar2, x, y, 0, NULL);
            x = 160;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, gNaturesInfo[sDebugPkmCreatorData.data[8]].name, x, y, 0, NULL);
            x = 208;
        ...
        case VAL_ITEM:
            ...
            *gStringVar3 = EOS;
            ...
            break;
        case VAL_ABILITY:
            StringCopy(gStringVar1, gAbilitiesInfo[GetAbilityBySpecies(sDebugPkmCreatorData.data[0], sDebugPkmCreatorData.data[index])].name);
            if (data->text != NULL)
            {
                bufferPosition = StringCopy(bufferPosition, data->text);
                bufferPosition = StringCopy(bufferPosition, Str_Spacer1);
        ...
        case VAL_METLOCATATION:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NARROW, gStringVar2, x, y, 0, NULL);
            x = 130;
            GetMapName(gStringVar1, sDebugPkmCreatorData.data[index], 0);
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, gStringVar1, x, y, 0, NULL);
            break;
        case VAL_BALL:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
        ...
        case VAL_MOVE_1 ... VAL_MOVE_4:
            ...
            *gStringVar3 = EOS;
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NARROW, gStringVar1, x, y, 0, NULL);
            x = 144;
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, GetMoveName(sDebugPkmCreatorData.data[index]), x, y, 0, NULL);
            break;
        case VAL_PKRUS_STRAIN:
            ConvertIntToDecimalStringN(gStringVar1, sDebugPkmCreatorData.data[index], STR_CONV_MODE_LEADING_ZEROS, data->digitCount);
            if (data->text != NULL)
...
static void DebugPkmCreator_EditModeRedraw(u32 digit, u8 editIndex)
{
    ...
    case VAL_SPECIES:
        ...
        if (editIndex == 0)
        {
            ...
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, GetSpeciesName(DebugPkmCreator_editingVal[editIndex]), x, y, 0, NULL);
    ...
    case VAL_PID:
        if (editIndex == 0) {
            ...
            u8 isSihny = DebugPkmCreator_IsShiny(DebugPkmCreator_GetOtId(), pid);
            ...
            x = 160;
            FillWindowPixelRect(sDebugPkmCreatorData.menuWindowId, 0x11, x, y, 120, 16);
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, gNaturesInfo[nature].name, x, y, 0, NULL);
            x = 208;
    ...
    case VAL_ABILITY:
        ...
        FillWindowPixelRect(sDebugPkmCreatorData.menuWindowId, 0x11, x, y, 120, 16);
        bufferPosition = StringCopy(bufferPosition, Str_Cursor2Color);
        bufferPosition = StringCopy(bufferPosition, gAbilitiesInfo[GetAbilityBySpecies(sDebugPkmCreatorData.data[0], DebugPkmCreator_editingVal[editIndex])].name);
        *bufferPosition = EOS;
        AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, FONT_NARROW, gStringVar2, x, y, 0, NULL);
        return;
    case VAL_METLOCATATION:
        ...
        if (editIndex == 0)
        {
            x = 130;
            FillWindowPixelRect(sDebugPkmCreatorData.menuWindowId, 0x11, x, y, 120, 16);
            GetMapName(gStringVar2, DebugPkmCreator_editingVal[editIndex], 0);
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, gStringVar2, x, y, 0, NULL);
            x = 100;
        }
        break;
    ...
    case VAL_MOVE_1 ... VAL_MOVE_4:
        ...
        if (editIndex == 0)
        {
            ...
            FillWindowPixelRect(sDebugPkmCreatorData.menuWindowId, 0x11, x, y, 120, 16);
            AddTextPrinterParameterized(sDebugPkmCreatorData.menuWindowId, 1, GetMoveName(DebugPkmCreator_editingVal[editIndex]), x, y, 0, NULL);
            x = 100;
        }
        break;
...
static void DebugPkmCreator_ToggleShiny(void)
{
    ...
    SetMonData(&sDebugPkmCreatorData.mon, MON_DATA_IS_SHINY, &isShiny);
    DebugPkmCreator_PopulateDataStruct();
        ...
        else
        {
            for (i = 0; i < 4; i++)
            {
                ...
                case VAL_SPECIES:
                    ...
                    SetMonData(&sDebugPkmCreatorData.mon, MON_DATA_NICKNAME, GetSpeciesName(DebugPkmCreator_editingVal[i]));
                    // Clear moves
